...
const { data } = await useAsyncData('my-favorites', () =>
  useApi()<PaginatedResponse<Favorite>>('/favorites', { query: { page: page.value, page_size: pageSize } }),
  { watch: [page] }
)
...
<template>
  <div class="container-page py-6">
    <h1 class="text-2xl md:text-3xl font-bold text-ink-900 mb-6">{{ t('favorites.title') }}</h1>
